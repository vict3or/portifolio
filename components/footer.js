    ...
    <div className={styles.footer}>
      <div>
        <div className={styles.contact}>
          ...
          <a href="https://www.linkedin.com/in/victor-ribeiro-oliveira/" target="_blank" rel="noreferrer"
            className="link"><svg stroke="currentColor" fill="white" strokeWidth="0" viewBox="0 0 1024 1024"
